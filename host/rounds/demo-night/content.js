const entries = {
  ...
  "fastest-beethoven": {
    ...
    media: "Audio placeholder — add a licensed or owned clip of Symphony No. 5.",
  },
  "fastest-strauss": {
    ...
    media: "Audio placeholder — add a licensed or owned clip of Also sprach Zarathustra.",
  },
  "fastest-vivaldi": {
    answer: "Antonio Vivaldi",
    acceptable: ["Antonio Vivaldi", "Vivaldi"],
    facts: ["Piece: Spring from The Four Seasons.", "Published in 1725."],
    media: "Audio placeholder — add a licensed or owned clip of Spring.",
  },
  "fastest-holst": {
    answer: "Gustav Holst",
    ...
    media: "Audio placeholder — add a licensed or owned clip of Mars.",
  },
